...
REPLACE INTO `gateway` (`id`, `status`, `sync`, `purge`, `type`, `location`, `port`, `timout`, `pid`, `pid_running_since`, `reboot`, `find_gw`, `version`) VALUES
	(1, 0, 0, 0, 'wifi', '192.168.0.231', '5003', '3', '3793', '', 0, 1, '2.3.1\n');
...
CREATE TABLE IF NOT EXISTS `gateway_logs` (
  ...
  `location` char(50) COLLATE utf16_bin DEFAULT '192.168.0.231' COMMENT 'ip address or serial port location i.e. /dev/ttyAMA0',
...
COLLATE='utf16_bin'
ENGINE=InnoDB;
>>>>>>> a1ddbcd69647f9f2db9183e08b6ff0f139235332
...
REPLACE INTO `mqtt` (`id`, `name`, `ip`, `port`, `username`, `password`, `enabled`, `type`) VALUES
	(1, 'Raspi3B', '192.168.0.200', 1883, 'mosquitto', 'mosquitto', 0, 0);
...
<<<<<<< HEAD
	(2, 1, 0, 'PiHome - Smart Heating Control', '1.64', '060819', 'http://www.pihome.eu/updates/', 'current-release-versions.php', 'pihome', 'DE', 'en', 'Alpen', '46519', '5a7b4b0b3c5455dc79314d95a43c2d11', '', b'1', 'Europe/Berlin', 0, 0, 0);
=======
